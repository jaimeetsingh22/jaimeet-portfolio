...
const TimeLine = () => {
 ...
 const FullstackElements = []

  for (let i = 0; i < data["fullstack-projects"].length; i++) {
    FullstackElements.push(
      {
        name: data["fullstack-projects"][i].title,
        date: data["fullstack-projects"][i].date,
      },
    )
  }

  console.log(FullstackElements);
